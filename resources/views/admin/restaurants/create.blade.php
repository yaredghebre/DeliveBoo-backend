            ...
            <div class="col-6">
                <form action="{{ route('admin.restaurants.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name')is-invalid @enderror" id="restaurant_name" name="name" >
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('address')is-invalid @enderror" id="restaurant_address" name="address">
                        @error('address')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('vat_number')is-invalid @enderror" id="restaurant_vat_number" name="vat_number">
                        @error('vat_number')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control  @error('image')is-invalid @enderror" id="restaurant_img" name="image">
                        @error('image')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
